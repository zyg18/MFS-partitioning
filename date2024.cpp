...
int main(int argc, char* argv[]) {
    ...
    std::string netlist_file_path = "./ICCAD2021-TopoPart-Benchmarks/generated_large_netlists/" + data;  // Generated_Benchmarks/Generated_Benchmarks/"
    ...
    std::vector<std::tuple<int, int>> fixed_nodes = find_fixed_nodes(netlist_matrix, num_fpgas);
